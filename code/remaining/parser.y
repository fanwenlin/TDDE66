...
const_decl      : T_IDENT T_EQ integer T_SEMICOLON
                {
                    ...
                    sym_index const_loc = sym_tab->enter_constant(pos, $1, integer_type, $3->value);
                }
                | T_IDENT T_EQ real T_SEMICOLON
                {
                    /* Your code here */
                    position_information *pos = new position_information(@1.first_line,  @1.first_column);
                    sym_index const_loc = sym_tab->enter_constant(pos, $1, real_type, $3->value);
                }
                ...
                | T_IDENT T_EQ const_id T_SEMICOLON
                {
                    ...
                    /* Your code here */
                    position_information *pos = new position_information(@1.first_line,  @1.first_column);
                    sym_index ref_sym_id = $3->sym_p;
                    constant_symbol *ref_sym = sym_tab->get_symbol(ref_sym_id)->get_constant_symbol();
                    if (ref_sym->type == integer_type) {
                        sym_index const_loc = sym_tab->enter_constant(pos, $1, integer_type, ref_sym->const_value.ival);
                    } else {
...
var_decl        : T_IDENT T_COLON type_id T_SEMICOLON
                ...
                | T_IDENT T_COLON T_ARRAY T_LEFTBRACKET integer T_RIGHTBRACKET T_OF type_id T_SEMICOLON
                {
                    /* Your code here */
                    position_information *pos = new position_information(@1.first_line,  @1.first_column);
                    sym_index var_type_id = $8->sym_p;
                    sym_index var_loc = sym_tab->enter_array(pos, $1, var_type_id, $5->value);
                }
