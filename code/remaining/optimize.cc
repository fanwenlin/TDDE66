...
void ast_elsif_list::optimize() { /* Your code here */
  if (preceding != NULL) {
    preceding->optimize();
  }
  if (last_elsif != NULL) {
...
void ast_indexed::optimize() { /* Your code here */
  if (index != NULL) {
    index->optimize();
  }
}
...
void ast_procedurecall::optimize() { /* Your code here */ }

void ast_assign::optimize() { /* Your code here */ }

void ast_while::optimize() { /* Your code here */ }

void ast_if::optimize() { /* Your code here */ }

void ast_return::optimize() { /* Your code here */ }

void ast_functioncall::optimize() { /* Your code here */ }

void ast_uminus::optimize() { /* Your code here */ }

void ast_not::optimize() { /* Your code here */ }

void ast_elsif::optimize() { /* Your code here */ }
...
void ast_cast::optimize() { /* Your code here */ }
